...
- **Periodic reminders** — pick an interval (15/30/45/60 min) in Settings and a piece of artwork drifts across your screen while a timer runs. Click-through and never steals focus. **Use your own image** via Settings ▸ Choose Image…; Tracki keys out the background and crops it for you.
...
└── Tracki/
    ...
    │   ├── FlybyPresenter.swift        # click-through overlay window + animation
    │   └── FlybyArtwork.swift          # artwork loading, import, background removal
